...
constraintmatrix <- read_excel("./script_noreden_julie/Example input files/1 Meat reduction/1.1/Input 1.1.xlsx")
constraintmatrix

## Import constraint limits (information on nutrient constraints)
limitsdata <- read_excel("./script_noreden_julie/Example input files/1 Meat reduction/1.1/Nutrient dir 1.1.xlsx") #containing data frame with nutrient, constraint direction and constraint limit (rhs=right-hand side) 
limitsdata


## Select relevant columns and rename them

# here i suggest to source from a reference table 
...
intakepercentiles <- read_excel("./script_noreden_julie/Example input files/1 Meat reduction/1.1/Realism 1.1.xlsx") 
...
library("writexl")
write_xlsx(list("Nutrients" = const_result2, 
                "Diet" = diet_result, 
                "Diet departure" = dietframe, 
                "Ruminant meat departure" = dietframe4, 
                "Red meat departure" = dietframe2, 
                "Total meat departure" = dietframe3), 
           "~/Documents/Input October/1.1/1.1 Result.xlsx")
